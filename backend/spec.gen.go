...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xb3W/bOBL/VwzePdK13e0Cd35Lt5erb9NukOZwD4FRMNbY5kYiVZJqGgT63w8kRX1Y",
	"37KddVu/BLA0ms/fjGaGyjNa8SDkDJiSaP6MQiJIAAqE+UXWCsR7wjwfrvUNfY0yNEdfIhBPCCNGAkBz",
	"S4cwkqstBERTqadQ35BKULZBcYwtTU8uAWU0iAI0n2LHkTIFG0P2bbzh4+RqRJkyUu5hzQV0UNkStuhs",
	"ifry6a/1tkLfkKhtJsZSIIwEfImoAA/NlYigIJZ8uwK2UVs0n/2KtRbu56+4wjafBlQ1mmYo0I4Ia9ls",
	"OsWZnbOudoZcqsW7JjstRbOdvd1r7Go01f2sl7rrwNgSg1RvuUfBpMtFpLb/lSDecu9J/15xpoApk0lh",
	"6NMVUZSzyZ+SM30tY/53AWs0R3+bZMk4sXflxDHNZGYKxhgtArKBCoFB5CsaEqEmay6CsUcU6S7zIzwa",
	"vjUyr/iGR6q3laHgIQiVOMs3TC4FDy58P+fhe859IAwZwWsBcnvLH4BVJ2im2l2Relmt+Ud4vOZSHTRA",
	"Cc8aX93ktNrTY4d2R+zwnYL3BmTImYSybKXZyDZX3FqqGKNII7aFOkF1Ue1EUMJhGeM0q4y7fP+PNZrf",
	"NTO25R/FeNeKpIr2K5a6qHAS0vGKe7ABNoZvSpCxIhvD07vPl+c1edCPPvugFAg2n01jW/mIlI9cePoJ",
	"nZBEmdKXXCwoMHvdUwMn07GztWvnz5r4EvDsdbyL07tMjWUqmN//CSuFYu3/fwnBRRkRD5R5ZRQWK7B5",
	"9HdNGGMUgJS6prQi1xFq4Zfc9/njJ0VUJMs6UGnvg1dRQLrEjcrPa8dBq+EYarX25Fh4TTjT8vxxXn1t",
	"6/sUnaeB2h3dE+pM02uyocyUrg+gKuoVg0eQqiLeGHHfq761IzOhw47XsoivogZ3lslSC9BdRk/tmpqI",
	"Co1beo7hVmgW1gb9Cq4vydSr1yZpa0wnVVKvE4y17M/Uy8AhH2hYAWgL3Sv6APVJqu/ukaG+ebwilyzf",
	"pX2v24alLN1dTqvuPWXENHvN0LMPlkti2kSUZeXbryxTX/9jOrCgS9D8VmBfIUYha5OCQHZGbkC+LewD",
	"b1I9iBDkqaMa1YF3tmrvt3qjf2lyD+MaZ6wEEAXehSqE1iMKxooGgHDje0mTvLq1dB10sbI+E1XKBnzc",
	"LNTTUFUSNoEhK7LDY62nwwfoCLEuhlh2ZTMEhD49pCDHsFbULT+4sM+KV8iTaTlsalVzhTPpmhfv6hXU",
	...
	"SkatBR6lU4d2I6wiQdXTJy3L2nUPRIC4iHQr6H5duoblP/+7dQtWu0zWd7PmZatU0npRtrYvLqp8owvw",
	"0IfRxfUCYfQVhKScoTmavZq+mppxJQRGQorm6BdzCZs9q1FokvUOYdK46TgYXyw8zZtLtbA0+SXnU51j",
	"C3vQSbaQNC61pcpIez2dHmzpVpyNjIs8kCtBQ2U98cfvWv6bA4q0e5AKUW+JN7qxPiiAwOyp8uG/W8Z6",
	"njA5eOdauKV+ZOLzDWXNIbkyJAMiUlhLHzMohRViQ0xmx4/Jgn0lPvVGvwnwgClKfFuwnPOJDkjqeh6p",
	"Vt9rmgHOz+3Ky65/YwpfQfGPfPRb4hnjq1+O76sPxNcTFHgj+y6v8VMAVlsfFJS99M5c/wBlHw3cduc3",
	"ps1tSba/rF7B93f6CwL02info3IEdgsXRlVojdReQei3Ye/m8cNVmOwg7OQqS5/Y2XSarMGuxTZQEch/",
	"g/oAl5oCF07layKTkUxyJ7sxbqXOn3F3IM8d42uzjhbp4vhWE/KBbs9PJA2+z00Zxw9A/pOFrmEoPLM8",
	"ctrJprx7c/y8+8jV6JJHrG+lLI4fBQgkU2IbBOwQc4bAdw8BHcgyBCbPdmiNu7Q3KSLeu0G3Hy62Lxmv",
	"HyJcTX3OORqDoqEl/vP4ErXRIypHxBdAvKdR4aR9n+zVc1rL/sK0D0PmtfwXQvGR+5tT3F+80Mx5ycU9",
	"9Txgp12NLNJyqJtIIGK1bWobDPQ+WbK+BSn3pWKHDuDc6CcRw8/NQXu2n5V2eMMbba7dR6j9gpf/urXC",
	"ZS17h/6gxM0QPI4VL18BT6o2dEXaJD1A74y3q+SM9Ryuo5RyG5COWXOAWODzjDi8hGfBqmv+z4nzXcwA",
	"2vj8DOC+5eudthUlNvfxUIeUvkk/XTm5pP4JejIXq2XyX0ANU9sBw7U8D4CDBsBTfYdnKNLlIPkAqXkR",
	"kPz/zZBVQOlfd44JB/evM/VAOJ2TYAEbKlXysVeD5xOqH+GThb/gM5IKx0e6weqwgjCN2MmuIH6SHjZM",
	"VpAmaIUA5g8cGkN4XmsfbXSvj0q38+FcfIYfFG/7ZcL5UPHkAFQ+Xa4EU8tJcwlMQ46cz2D6UcCUnXTt",
	"gCldKnYA0rCtyAuA6Pucdk8cQPk1yQ5o0tPSDqBxx6Zn0PwMoEmPL8xT4qsLdyR8NEcTElIUL+P/BwAA",
	"///Pe0iiI0gAAA==",
}
