...
func (s *service) FromUser(handle string, p people.SeekPagination) (people.Posts, error) {
	return people.SeekPaginationSelect[people.Post](s.db, &fromUserQueries, p, handle)
}

func (s *service) Feed(userID uint, p people.SeekPagination) (people.Posts, error) {
	return people.SeekPaginationSelect[people.Post](s.db, &feedQueries, p, userID)
}
